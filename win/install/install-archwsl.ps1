...
$GITHUB_DOTFILES_BRANCHNAME = 'wsl'
$SCOOP_PKG_LIST_DEFAULT = "https://raw.githubusercontent.com/filipealvesdef/dotfiles/wsl/win/install/package-list";
$SYNC_LINKS_SCRIPT_URL = "https://raw.githubusercontent.com/filipealvesdef/dotfiles/wsl/win/scripts/sync-links.bat";
...
on github (default: $GITHUB_DOTFILES_BASENAME)"
    ...
    git clone --branch "$GITHUB_DOTFILES_BRANCHNAME"`
        "https://github.com/$GITHUB_DOTFILES_BASENAME.git" "$DOTFILES_PATH"
}
